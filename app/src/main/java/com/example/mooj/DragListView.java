...
public class DragListView extends ListView {
    ...
    public ArrayList<Ashjar> mCheeseList;
    ...
    private void updateNeighborViewsForID(long itemID) {
        ...
        AdaptSort adapter = ((AdaptSort)getAdapter());
    ...
    private void swapElements(ArrayList<Ashjar> arrayList, int indexOne, int indexTwo) {
        Ashjar temp = arrayList.get(indexOne);
    ...
    public void setCheeseList(ArrayList<Ashjar> cheeseList) {
